...
The main utility of `rescomp` comes with specifying more elaborate models and simulation dynamics. Features/options include: 
...
The below example demonstrates how to build and simulate a model for two consumers with type II functional responses on a single logistically growing resources. A wide range of other examples can be found in the package vignette. 
