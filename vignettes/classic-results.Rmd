...
```{r, fig.width = 8, fig.height = 3, fig.cap = "Reproduces Fig 1c from Huisman and Weissing (1999)."}
...
```{r, fig.width = 4, fig.height = 3, fig.cap = "Reproduces Fig 1 from Grover (1990). Resource concentration in $mu$mol per ml rather than  per L."}
...
```{r, fig.width = 4, fig.height = 3, warning = FALSE, fig.cap = "Reproduces Fig 4A from Grover (1990)."}
...
```{r, fig.width = 4, fig.height = 3, fig.cap = "Reproduces Fig 4B from Grover (1990)."}
m1 <- sim_rescomp(pars)
...
```{r, fig.width = 4, fig.height = 3, fig.cap = "Reproduces Fig 4C from Grover (1990)."}
m4 <- sim_rescomp(pars)
...
```{r, fig.width = 4, fig.height = 3, fig.cap = "Reproduces Fig 4D from Grover (1990)."}
...
```{r, fig.width = 4, fig.height = 3, fig.cap = "Corresponds to Fig 2 from Armstrong and McGehee (1980)."}
...
```{r, fig.width = 6, fig.height = 3, fig.cap = "Corresponds to Fig 1 from Armstrong and McGehee (1980). The paper states that the model was initated with R = 400, but here it is started with R = 100 to provide a closer correspondence to the original figure."}
plot_rescomp(m1)
```
